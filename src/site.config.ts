...
const config: SiteConfig = {
  ...
  site: 'https://rafiqul.dev',
  // The name of your site, used in the title and for SEO.
  title: 'Rafiqul.dev',
  // The description of your site, used for SEO and RSS feed.
  description: 'A Software Artisan, who attempts to share something to the world here',
  // The author of the site, used in the footer, SEO, and RSS feed.
  author: 'Rafiqul Hasan',
  // Keywords for SEO, used in the meta tags.
  tags: ['Python', 'Rafiqul', 'Software Engineer', 'FastAPI', 'shopnilsazal'],
  ...
  navLinks: [
    ...
    {
      name: 'GitHub',
      url: 'https://github.com/shopnilsazal',
      external: true,
    },
  ],
  ...
  giscus: {
    repo: 'shopnilsazal/rafiqul.dev',
    repoId: 'R_kgDOQKBbIw',
    category: 'General',
    categoryId: 'DIC_kwDOQKBbI84CzvCb',
