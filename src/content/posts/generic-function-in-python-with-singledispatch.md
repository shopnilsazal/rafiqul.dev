...
draft: false
description: 'An overview of how we can implement generic function in Python with Singledispatch'
tags: ['python']
---
...
Now, it's time for the ultimate test. Let's call the same `fprint` function with different data types.

```shell title="Calling function with string"
>>> fprint('hello')
(str) hello
```

```shell title="Calling function with integer"
>>> fprint(21)
(int) 21
```

```shell title="Calling function with float"
>>> fprint(3.14159)
(float) 3.14159
```

```shell title="Calling function with list"
>>> fprint([2, 3, 5, 7, 11])
list -> index : value
---------------------
0 : (int) 2
...
```shell title="Calling function with set"
>>> fprint({2, 3, 5, 7, 11})
set -> index : value
--------------------
0 : (int) 2
...
```shell title="Calling function with tuple"
...
```shell title="Calling function with dictionary"
